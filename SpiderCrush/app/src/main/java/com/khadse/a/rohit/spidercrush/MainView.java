...
public class MainView extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public MainView (Context context) {
        ...
        prefs=context.getSharedPreferences("com.khadse.a.rohit.spidercrush",context.MODE_PRIVATE);
        String spackage="com.khadse.a.rohit.spidercrush";
        Assets.oldScore=prefs.getInt(saveScore,0);
        ...
        Assets.sound_squish4 = Assets.soundPool.load(context, R.raw.squish4, 1);
        Assets.sound_thump = Assets.soundPool.load(context, R.raw.thump, 1);
        Assets.cave = Assets.soundPool.load(context, R.raw.cave, 1);
...
//		}
    ...
    @Override public void surfaceDestroyed(SurfaceHolder sh) {
        ...
        prefs.edit().putInt(saveScore,Assets.oldScore).commit();
    }
}